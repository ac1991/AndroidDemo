...
package com.example.sharedscreen.encoder;
...
//     * @param display for {@link VirtualDisplay#setSurface(Surface)}
    ...
    private VirtualDisplay getOrCreateVirtualDiaplay(Context context, Surface surface){
        if (mVirtualDisplay == null){
            ...
            if (displayManager != null){
                mVirtualDisplay = displayManager.createVirtualDisplay("test", 1080, 1920, context.getResources().getConfiguration().densityDpi, surface, 0);
            }
        }
...
//        mVirtualDisplay.setSurface(mVideoEncoder.getInputSurface());
        ...
        mVirtualDisplay = getOrCreateVirtualDiaplay(mContext, mVideoEncoder.getInputSurface());
